...
var mariorightAnimation,marioleftAnimation,mariostandAnimation,obstacleAnimation,wallAnimation,groundAnimation,beeAnimation,t1Animation,t2Animation,t3Animation,t4Animation,
...
rainAnimation,storyAnimation,instructionsAnimation,redcovidAnimation,orangecovidAnimation,crowdAnimation,railtracksAnimation,playbtnAnimation,storybtnAnimation,insbtnAnimation,winAnimation,shootingAnimationl;
...
crowdAnimation=loadAnimation("crowd.png");
  ...
  mariojumpAnimation=loadAnimation("mj1.png","mj2.png","mj3.png","mj4.png");
  mariostandAnimation=loadAnimation("mariostand.png");
...
if(keyDown("b")){
  ...
  else if(gameState==WIN)//win state.
  {
